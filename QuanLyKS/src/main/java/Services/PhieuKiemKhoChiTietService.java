...
public class PhieuKiemKhoChiTietService {
	...
	private PhieuKiemKhoChiTietDao _PhieuKiemKhoChiTietDao =  new PhieuKiemKhoChiTietDao();
	...
	public static PhieuKiemKhoChiTiet modelToEntity(PhieuKiemKhoChiTietModel pkkctm) {
		...
		pkkct.setSanPhamVaDichVu(new SanPhamVaDichVu(pkkctm.getSanPhamVaDichVuModel().getMaDichVu()));
